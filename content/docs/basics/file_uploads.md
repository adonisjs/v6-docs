---
summary: ユーザーがアップロードしたファイルを `request.file` メソッドを使用し、バリデータを使用してバリデーションする方法を学びます。
---
...
[バリデータ](#バリデータを使用してファイルをバリデーションする)を使用してファイルをバリデーションするか、`request.file`メソッドを使用してバリデーションルールを定義できます。
