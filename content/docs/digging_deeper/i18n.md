...
また、[カスタムメッセージフォーマッター](#creating-a-custom-translation-formatter)を追加することもできます。
...
翻訳を読み込むために使用するローダーのコレクションです。デフォルトでは、ファイルシステムローダーのみをサポートしています。ただし、[カスタムローダー](#creating-a-custom-translation-loader)を追加することもできます。
